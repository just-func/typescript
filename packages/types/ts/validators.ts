 ...
 */
export function isJustUno<V>(value: unknown, validator?: (v: JustValue<V>) => unknown): value is JustUno<V> {
...
export function isJustValue<V = void, M extends JustMeta | undefined = undefined>(
	value: unknown,
	validator?: (value: JustValue<V, M>) => unknown,
): value is JustValue<V, M> {
